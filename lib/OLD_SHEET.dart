...
// Derilect Code, new_sheet.dart is used now.

class OldSheet extends StatefulWidget {
  final Map<String, dynamic> character;

  const OldSheet({Key? key, required this.character}) : super(key: key);

  @override
  State<OldSheet> createState() => _OldSheetState();
}

class _OldSheetState extends State<OldSheet> with RouteAware {
          ...
          Row(
            ...
            children: [
              Card(
                child: Column(
                  children: const [
                    //There used to be stat displays here
                  ],
                ),
              ),
              Column(
